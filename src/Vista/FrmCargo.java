...
public class FrmCargo extends javax.swing.JFrame {
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        // TODO add your handling code here:
        ControladorCargo cm = new ControladorCargo();
        ArrayList<Cargo> listado = cm.buscarTodos();
        ...
        for(Cargo m: listado)
            dtm.addRow(new Object[]{m.getIdCargo(), 
                                    m.getNombre()
                                  });
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Ingrese un cargo valido");
            return;
        }
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        cargo.setIdCargo(id);// id necesario para modificar o eliminar
